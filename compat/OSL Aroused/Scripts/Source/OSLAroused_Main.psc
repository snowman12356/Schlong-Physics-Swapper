...
Function OnGameLoaded()
    ...
    if (Game.GetModByName("SexLabAroused.esm") != 255)
		Quest slaQuest = Game.GetFormFromFile(0x4290F, "SexLabAroused.esm") as Quest
		SlaFrameworkStub = slaQuest as slaFrameworkScr
...
function UpdateSOSPosition(Actor act, float arousal)
	; Schlong Physics Swapper owns the player's SOS position. Keep OSL's
	; original arousal-driven SOS behavior for every NPC.
